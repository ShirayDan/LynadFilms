		...
		<div className='lg:grid grid-cols-tabs'>
			...
			<ul className='px-4 pb-10 lg:pr-0 lg:pl-4'>
				<li className='flex justify-between font-bold text-sm pb-3 lg:flex-col'>
					Full name:{' '}
					<span className='font-normal whitespace-nowrap'>{data.name}</span>
				</li>
				<li className='flex justify-between font-bold text-sm pb-3 lg:flex-col'>
					Date Of Birth:{' '}
					<span className='font-normal  whitespace-nowrap'>{data.birth}</span>
				</li>
				<li className='flex justify-between font-bold text-sm pb-3 lg:flex-col'>
					Country:{' '}
					<span className='font-normal  whitespace-nowrap'>{data.country}</span>
				</li>
				<li className='flex justify-between font-bold text-sm pb-3 lg:flex-col'>
					Height:{' '}
